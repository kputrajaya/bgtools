  ...
  'Generic: 1 Value': [
    {
      name: 'Players',
      open: true,
      items: [...Array(4).keys()].map((i) => ({ name: `P${i + 1}`, metrics: [{ value: 0 }], size: 2 })),
    },
    {
      name: 'Players',
      open: false,
      items: [...Array(4).keys()].map((i) => ({ name: `P${i + 5}`, metrics: [{ value: 0 }], size: 2 })),
    },
    {
      name: 'Players',
      open: false,
      items: [...Array(4).keys()].map((i) => ({ name: `P${i + 9}`, metrics: [{ value: 0 }], size: 2 })),
    },
  ],
  'Generic: 2 Values': [
    {
  ...
  'Generic: 3 Values': [
    {
      ...
      items: [...Array(4).keys()].map((i) => ({
        name: `P${i + 1}`,
        metrics: [{ value: 0 }, { value: 0, context: 'warning' }, { value: 0, context: 'success' }],
        size: 2,
      })),
    },
    {
  ...
  'Generic: 4 Values': [
    {
      ...
      items: [...Array(4).keys()].map((i) => ({
        name: `P${i + 1}`,
        metrics: [{ value: 0 }, { value: 0, context: 'warning' }, { value: 0, context: 'success' }, { value: 0, context: 'info' }],
        size: 2,
      })),
    },
    {
